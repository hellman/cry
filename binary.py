...
def test_binary():
    assert hamming(0) == hamming(0) == hamming(Integer(0)) == 0
    assert hamming(1) == hamming(1) == hamming(Integer(1)) == 1
    assert hamming(2) == hamming(2) == hamming(Integer(2)) == 1
    v = 1889421344686260973171433197677248273467675043680169246693717736553773868585782209193108237
    assert hamming(int(v)) == hamming(Integer(v)) == 159
